...
def build_grind_fragment(payload: dict) -> FragmentLogRequest:
    ...
    ritual_type = payload.get("ritual_type", "grind")
    ...
    # --- Build body (grind tone: pressure, constraint, friction) ---
    body = raw_text or f"Grind: {symbolic_anchor}" or "Grind fragment"
