...
def build_emerge_fragment(payload: dict) -> FragmentLogRequest:
    ...
    ritual_type = payload.get("ritual_type", "emerge")
    ...
    # --- Build body (emerge tone: frisson, rising insight, breakthrough) ---
    body = raw_text or f"Emerge: {symbolic_anchor}" or "Emerge fragment"
