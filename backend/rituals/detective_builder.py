...
def build_detective_fragment(payload: dict) -> FragmentLogRequest:
    ...
    ritual_type = payload.get("ritual_type", "detective")
    ...
    # --- Build body (detective-style narrative) ---
    body = raw_text or f"Clue: {symbolic_anchor}" or "Detective fragment"
