# purge_skipped_from_notes_backend.py — Final Ghost Sweep (Correct DB)
...
db = client["backend"]  # ✅ Correct database
...
print(f"\n✅ Purged {count} fragments from backend. Skipped echoes removed from notes field.")
